...
# Dimension of extra features
_C.MODEL.HEADS.EXTRA_FEAT = 0
...
# Npair loss options
_C.MODEL.LOSSES.NPAIR = CN()
_C.MODEL.LOSSES.NPAIR.L2_REG = 1e-6
_C.MODEL.LOSSES.NPAIR.MARGIN = 0.05
_C.MODEL.LOSSES.NPAIR.SCALE = 40
_C.MODEL.LOSSES.NPAIR.HARD_MINING = False
_C.MODEL.LOSSES.NPAIR.MEMORY_BANK_SIZE = 0

# similarity matric difference loss
_C.MODEL.LOSSES.SM = CN()
_C.MODEL.LOSSES.SM.PKT = False
_C.MODEL.LOSSES.SM.DWS = False
_C.MODEL.LOSSES.SM.EPS = 1e-8

# LogSumExp loss
_C.MODEL.LOSSES.MAXL2 = CN()
_C.MODEL.LOSSES.MAXL2.scale = 10

# Uncertainty loss
_C.MODEL.LOSSES.UNCERTAIN = CN()
_C.MODEL.LOSSES.UNCERTAIN.IN_FEAT = 512
_C.MODEL.LOSSES.UNCERTAIN.OUT_FEAT = 256

# L2 loss options
_C.MODEL.LOSSES.FEATL2 = CN()
_C.MODEL.LOSSES.FEATL2.L2_NORM = False
_C.MODEL.LOSSES.FEATL2.DWS = False
_C.MODEL.LOSSES.FEATL2.DISTANCE_MINING = False
_C.MODEL.LOSSES.FEATL2.TRANSFORM = ''
_C.MODEL.LOSSES.FEATL2.WEIGHT = ''
...
# Random Channel
_C.INPUT.RC = CN()
_C.INPUT.RC.ENABLED = False
_C.INPUT.RC.PROB = 0.5
...
_C.DATASETS.SPLIT_FILE = ""
_C.DATASETS.ROOT = ""
_C.DATASETS.TRAIN_ROOTS = []
_C.DATASETS.TEST_ROOTS = []

_C.DATASETS.EXTRA_DATA = CN()
_C.DATASETS.EXTRA_DATA.ROOTS = [""]
_C.DATASETS.EXTRA_DATA.LISTS = [""]

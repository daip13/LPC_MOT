...
from fastreid.modeling.losses import CrossEntropyLoss, TripletLoss, NpairLoss
...
class MGN(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            b1_head_res = self.b1_head(b1_pool_feat, targets=targets)
            b1_logits, pred_class_logits, b1_pool_feat = b1_head_res['cls'], b1_head_res['logits'], b1_head_res['feat']

            b2_head_res = self.b2_head(b2_pool_feat, targets=targets)
            b2_logits, _, b2_pool_feat = b2_head_res['cls'], b2_head_res['logits'], b2_head_res['feat']

            b21_head_res = self.b21_head(b21_pool_feat, targets=targets)
            b21_logits, _, b21_pool_feat = b21_head_res['cls'], b21_head_res['logits'], b21_head_res['feat']

            b22_head_res = self.b22_head(b22_pool_feat, targets=targets)
            b22_logits, _, b22_pool_feat = b22_head_res['cls'], b22_head_res['logits'], b22_head_res['feat']

            b3_head_res = self.b3_head(b3_pool_feat, targets=targets)
            b3_logits, _, b3_pool_feat = b3_head_res['cls'], b3_head_res['logits'], b3_head_res['feat']

            b31_head_res = self.b31_head(b31_pool_feat, targets=targets)
            b31_logits, _, b31_pool_feat = b31_head_res['cls'], b31_head_res['logits'], b31_head_res['feat']   

            b32_head_res = self.b32_head(b32_pool_feat, targets=targets)
            b32_logits, _, b32_pool_feat = b32_head_res['cls'], b32_head_res['logits'], b32_head_res['feat']   

            b33_head_res = self.b33_head(b33_pool_feat, targets=targets)
            b33_logits, _, b33_pool_feat = b33_head_res['cls'], b33_head_res['logits'], b33_head_res['feat'] 
            ...
            b1_pool_feat = self.b1_head(b1_pool_feat)['feat']
            b2_pool_feat = self.b2_head(b2_pool_feat)['feat']
            b21_pool_feat = self.b21_head(b21_pool_feat)['feat']
            b22_pool_feat = self.b22_head(b22_pool_feat)['feat']
            b3_pool_feat = self.b3_head(b3_pool_feat)['feat']
            b31_pool_feat = self.b31_head(b31_pool_feat)['feat']
            b32_pool_feat = self.b32_head(b32_pool_feat)['feat']
            b33_pool_feat = self.b33_head(b33_pool_feat)['feat']
    ...
    def losses(self, outputs, gt_labels):
        ...
        if "NpairLoss" in loss_names:
            loss_dict['loss_npair_b1'] = NpairLoss(self._cfg)(b1_pool_feat, gt_labels)
            loss_dict['loss_npair_b2'] = NpairLoss(self._cfg)(b2_pool_feat, gt_labels)
            loss_dict['loss_npair_b3'] = NpairLoss(self._cfg)(b3_pool_feat, gt_labels)
            loss_dict['loss_npair_b22'] = NpairLoss(self._cfg)(b22_pool_feat, gt_labels)
            loss_dict['loss_npair_b33'] = NpairLoss(self._cfg)(b33_pool_feat, gt_labels)
        return loss_dict

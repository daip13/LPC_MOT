...
class MSMT17(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, main_dir, 'bounding_box_train')
        self.test_dir = osp.join(self.dataset_dir, main_dir, 'bounding_box_test')
    ...
    def process_dir(self, dir_path, list_path=None, is_train=True):
        ...
        for img_path in img_paths:
            pid, camid, _ = img_path.split('/')[-1].split('_')
            pid = int(pid)  # no need to relabel

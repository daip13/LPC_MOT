...
__all__ = ['ToTensor', 'RandomErasing', 'RandomPatch', 'AugMix', 'RandomChannel']
...
class RandomChannel(object):
    '''Random channel data augmentation, designed for NAIC ReID2020
    Because the provided dataset is processed by randomly combining gray image to generate RGB images,
    we will imitate this process by randomly exchanging R, G, B channels
    '''

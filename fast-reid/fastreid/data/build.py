...
def build_reid_train_loader(cfg):
    ...
    for d in cfg.DATASETS.NAMES:
        dataset = DATASET_REGISTRY.get(d)(root=_root, combineall=cfg.DATASETS.COMBINEALL, split_file=cfg.DATASETS.SPLIT_FILE, extra_data_cfg=cfg.DATASETS.EXTRA_DATA)
...
def build_reid_test_loader(cfg, dataset_name):
    ...
    dataset = DATASET_REGISTRY.get(dataset_name)(root=_root, split_file=cfg.DATASETS.SPLIT_FILE)
    if comm.is_main_process():
        dataset.show_test()

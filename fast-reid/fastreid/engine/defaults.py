...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default="./configs/NAIC/mgn_R50-ibn.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
...
class DefaultPredictor:
    ...
    def __call__(self, image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            predictions = self.model(inputs)['feat']
...
class DefaultTrainer(SimpleTrainer):
    ...
    def __init__(self, cfg):
        ...
        self.build_testloader_evaluator(cfg)
    ...
    def auto_scale_hyperparams(cfg, data_loader):
        ...
        cfg.SOLVER.CHECKPOINT_PERIOD *= iters_per_epoch + num_mod
